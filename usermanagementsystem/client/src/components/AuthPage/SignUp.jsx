      ...
      <div className="auth-card">
        ...
        >
          <div className="auth-form__group">
            ...
            {errors.name && (
              <div className="auth-form__form-error">{errors.name}</div>
            )}
          </div>
          ...
          <div className="auth-form__group">
            ...
            {errors.email && (
              <div className="auth-form__form-error">{errors.email}</div>
            )}
          </div>
          ...
          <div className="auth-form__group">
            ...
            {errors.phone && (
              <div className="auth-form__form-error">{errors.phone}</div>
            )}
          </div>
          ...
          <div className="auth-form__group">
            ...
            {errors.password && (
              <div className="auth-form__form-error">{errors.password}</div>
            )}
          </div>
          ...
          {errors.message && (
            <div className="auth-form__form-error">{errors.message}</div>
          )}
        </form>
