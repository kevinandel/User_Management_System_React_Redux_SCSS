  ...
  return (
    <header className="home-header">
      <div className="home-header__container">
        ...
        <nav className={`home-header__nav ${isMenuOpen ? "active" : ""}`}>
          <div className="home-header__profile-container">
            {/* Admin Links */}
            <div className="home-header__profile">
              <Link to="/admin/dashboard" className="home-header__profile-link">
                <div className="home-header__profile-image">
                  <FiUsers />
                </div>
                <span className="home-header__profile-text">Manage Users</span>
              </Link>
            </div>
